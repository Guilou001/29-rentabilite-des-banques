...
#align(center)[
  #block(width: 100%)[
    ...
    #v(0.6em)
    #text(size: 10pt, fill: luma(70))[Guillaume Vaudescal · 2026-08-30 · #link("https://github.com/Guilou001/29-rentabilite-des-banques")[Guilou001/29-rentabilite-des-banques]]
  ]
]
#v(1.2em)
...
Une banque qui garde trente cents de chaque dollar encaissé, contre dix-neuf il y a vingt-huit ans, devrait rapporter davantage. Les six grandes banques canadiennes rapportent pourtant trois points de moins qu'en 1997. Ce dépôt sépare les causes, sur les relevés que les banques déposent au régulateur.

*Résultat en une phrase.* Sur 174 exercices et six banques de 1997 à 2025, la marge a ajouté *+5,7 points* au rendement des capitaux propres, mais deux choses lui en ont retiré *8,6* : chaque dollar de bilan produit moins de revenu qu'avant (*−4,5 points*) et les banques portent un tiers de levier en moins (*−4,1 points*) ; le rendement moyen passe donc de *15,95 % à 12,98 %*, et l'identité qui le décompose se referme à *5,6 × 10⁻¹⁷*.
...
Le deuxième est que *la ligne 22 du formulaire n'est pas le revenu brut*. Elle est déjà nette des provisions pour créances douteuses. Le revenu brut est la somme des lignes 14 et 21, et prendre la 22 sous-estimerait la productivité de six à douze pour cent selon la banque, au dernier exercice.
...
Le quatrième est que *deux lignes signées manquent à la descente si on les oublie*. Les activités abandonnées valent moins 1,8 milliard chez la Banque Royale en 2011, l'exercice où elle a vendu sa banque de détail américaine ; les éléments extraordinaires valent plus 309 millions chez la Toronto-Dominion en 2008. Sans elles, la descente laisse un écart de 7,9 % du revenu brut ; avec elles, de un millionième.
...
+ *Vérifier les trois identités* avant d'interpréter quoi que ce soit.
...
Comment lire ce tableau, en trois constats. Le premier est que la première ligne est un contrôle du code et non des données : l'identité de DuPont est vraie par construction, et un écart visible aurait signalé une erreur de programmation. Le deuxième est que les deux autres portent sur les données elles-mêmes, et qu'elles tiennent : le bilan des banques canadiennes se referme *exactement* sur 19 238 des 19 241 fins de mois publiées, les trois autres à mille dollars près, ce qui est l'unité de publication du relevé. Le troisième est que l'écart de 8 000 \$ sur la descente n'a été atteint qu'après avoir trouvé les quatre pièges de la section 3 ; avant, il valait 1,9 milliard.
...
Comment lire ce tableau, en trois constats. Le premier est que sur vingt-huit ans la marge a ajouté 5,67 points de rendement, ce qui est considérable, et que le rendement a quand même baissé de 2,97 points : les deux autres facteurs en ont retiré 8,64 à eux deux. Le deuxième est que la crise de 2008 se lit dans la marge et non dans le levier, contrairement à ce qu'on attendrait : entre 2007 et 2009 le levier n'explique que 1,17 point sur 7,54, parce que le désendettement des banques canadiennes est venu *après* la crise et non pendant, comme le montre la période suivante où le levier retire 2,45 points. Le troisième est que les quatre premières lignes ne s'additionnent pas pour donner la cinquième : l'attribution est exacte à l'intérieur d'une période, pas entre périodes, et le dépôt publie donc la période longue comme une ligne à part plutôt que comme une somme.
...
Comment lire ce tableau, en trois constats. Le premier est que la Banque de Nouvelle-Écosse est la seule dont la marge a *baissé* en vingt-huit ans, et c'est aussi celle qui perd le plus : elle partait de la meilleure position des six et finit à la dernière place. Le deuxième est que la Banque Nationale a la plus forte progression de marge, +8,94 points, et finit pourtant à plat : sa productivité d'actif a reculé plus que celle de toutes les autres. Le troisième est que la contribution du levier est du même ordre pour les six, de −3,0 à −5,4 points, ce qui est attendu : c'est le même régulateur qui a fixé les mêmes exigences de fonds propres aux six.

#figure(image("../results/figures/trois_facteurs.png", width: 100%), caption: [Les trois facteurs, exercice par exercice])

Comment lire cette figure : un cadre par facteur, une ligne par banque. Le creux nommé du cadre de gauche est l'exercice 2008 de la Banque Canadienne Impériale de Commerce, dont le revenu brut est tombé de 12,07 à 3,71 milliards et qui a perdu 2,06 milliards : sa marge vaut cette année-là moins 55 % et son coefficient d'exploitation 194 %. Le cadre de droite montre que le levier ne baisse pas en 2008 mais à partir de 2009.
...
Comment lire cette figure : la première barre est le revenu brut, ramené à 100. Les trois suivantes retranchent les provisions pour créances douteuses, les frais de fonctionnement et l'impôt. La dernière est ce qui reste. Les frais pèsent huit fois plus que les provisions, ce qui explique pourquoi le premier chiffre qu'un analyste de banque regarde est le coefficient d'exploitation.
...
Comment lire cette figure : à gauche les frais rapportés au revenu brut, à droite le rendement, avec la moyenne des six en trait épais. Le coefficient d'exploitation passe de 63,6 % en 1997 à 55,9 % en 2025, mais l'amélioration n'est pas continue : il *empire d'abord*, jusqu'à 68,3 % en 2003, et ne descend qu'à partir de 2009. La pointe nommée à 194 % est l'exercice 2008 de la Banque Canadienne Impériale de Commerce, dont les frais ont dépassé le revenu brut effondré.
...
Comment lire ce tableau, en trois constats. Le premier est que l'exercice 2021, qui court de novembre 2020 à octobre 2021, est le plus bas depuis 2005 : il tombe entièrement à l'intérieur de la restriction du BSIF, qui a demandé aux institutions en mars 2020 de ne pas augmenter leurs dividendes ni racheter d'actions, et l'a levée le 4 novembre 2021 (source citée en section 8). Le deuxième est que l'exercice 2012 dépasse cent pour cent, ce qui ne veut pas dire que les banques ont distribué plus qu'elles n'ont gagné : c'est l'exercice de première application des normes comptables internationales, dont l'ajustement d'ouverture a été imputé aux bénéfices non répartis. Le troisième est que ce résidu *n'est pas un taux de distribution* et que le dépôt ne l'appelle pas ainsi : il mélange les dividendes, les rachats d'actions imputés aux bénéfices non répartis et les retraitements comptables, et rien dans les relevés publics ne permet de les séparer.
...
Comment lire cette figure : une ligne fine par banque, la moyenne des six en trait épais, la bande colorée marquant les exercices couverts par la restriction du BSIF. Le creux de 2021 et le pic de 2012 sont nommés sur la figure parce que sans nom ils passeraient pour du bruit.

== 6. Reproduire

#raw("uv sync --locked --all-extras\nuv run pytest                 # 24 tests fermés, sans réseau ni gros fichiers\nuv run rdb fetch              # les deux relevés du BSIF, 979 Mo\nuv run rdb entrepot           # l'entrepôt DuckDB, 1 900 048 lignes\nuv run rdb tout               # les quatre études et les cinq figures", block: true, lang: "bash")

Les tests tournent sur les formules et sur une banque fabriquée dont chaque rapport tombe rond. Tous les chiffres de ce README viennent des fichiers de #raw("results/").
...
#table(
  ...
  inset: 5pt,
    ...
    [déclaré ; l'entrepôt en contient 110, et le code s'applique à n'importe laquelle, mais l'exercice ne se clôt pas toutes en octobre],
